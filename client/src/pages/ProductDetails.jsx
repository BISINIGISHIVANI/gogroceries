...
const ProductDetails = () => {
    const {products,currency,navigate,addToCart,getCartCount}=useAppContext();
    const {id}=useParams();
    ...
    useEffect(() => {
        if(products.length>0){
            let relatedProducts=products.filter((item)=>item.category===product.category&&item._id!==product._id);
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        <button 
                        onClick={()=>{
                          getCartCount() ===0&& addToCart(product._id);     
                                navigate('/cart'); }}

  ...
  return (
    <div className='relative'>
        ...
        <div className='flex items-center mt-6 font-medium'>
            <Link to='/products' className='group flex items-center gap-2 bg-primary text-white px-7 md:px-9 py-3 rounded hover:bg-primary-dull transition cursor-pointer'>
            Shop now

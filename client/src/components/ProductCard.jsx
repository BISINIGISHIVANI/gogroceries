...
const ProductCard = ({product}) => {
        ...
        return product&& (<div className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-56 w-full">
                ...
                <div className="text-gray-500/60 text-sm">
                    ...
                    <div className="flex items-center gap-0.5">
                        {Array(5).fill('').map((_, i) => (
                               <img key={i} src={i<4?assets.star_icon:assets?.star_dull_icon} alt={i}  className='md:w-3.5 w-3xw'/>
                        ))}
                        <p>(4)</p>
                    </div>
                    <div className='flex justify-between mt-3'>
                      <div className="md:text-xl text-base font-medium text-primary flex flex-row items-center gap-1.5">
